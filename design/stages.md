...
5. [Stage 4: Implement HTTP Endpoints (complete)](stages/stage-4-implement-http-endpoints/plan.md)
...
Stages 0 through 4 are complete. Each later stage requires the preceding
stage's exit criteria to pass.

Stage 5 can now complete the end-to-end cache and upstream interaction
coverage.
